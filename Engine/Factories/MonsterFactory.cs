    ...
    internal static class MonsterFactory
    {
        ...
        public static Monster GetMonster(int MonsterID)
        {
            ...
            switch(MonsterID)
            {
                case 1:
                    {
                        Monster snake = new Monster(2, 4, "Snake", "A venomous snake", "Snake.png", 20, 25,1,2);
                ...
                case 2:
                    {
                        Monster giantSpider = new Monster(4,6, "GiantSpider", "A dangerous spider", "GiantSpider.png", 25, 35, 1, 4);
                ...
                case 3:
                    {
                        Monster rat = new Monster(4, 5, "Rat", "Cheesy Rat", "Rat.png", 10, 10, 1, 1);
